...
execute if score @s RD.ai_timer matches 1..199 run data modify entity @s CustomName.text set string entity @s equipment.head.components."minecraft:custom_data".fuel 0 3
execute if score @s RD.ai_timer matches 200..1999 run data modify entity @s CustomName.text set string entity @s equipment.head.components."minecraft:custom_data".fuel 0 4
