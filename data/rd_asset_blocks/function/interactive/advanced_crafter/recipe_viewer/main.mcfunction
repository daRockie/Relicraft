...
execute if items block ~ ~ ~ container.10 *[custom_data~{TempItem:1b}] if items entity @a player.cursor *[custom_data~{TempItem:1b} | custom_data~{Ingredient:1b}] run function rd_asset_blocks:interactive/advanced_crafter/utils/recipe_mode/show_recipe
