...
# execute positioned ~ ~1 ~ if predicate rd_custom_items:can_see_sky run data modify entity @n[type=block_display] brightness.sky set value 14
# execute positioned ~ ~1 ~ unless predicate rd_custom_items:can_see_sky run data modify entity @n[type=block_display] brightness.sky set value 1
