...
item replace block ~ ~ ~ container.16 with barrier[custom_name={"text":"魔導書をセットしてください","color":red,"italic":0b},lore=[{"text":"ここにクラフト結果が表示されます。",color:"gray","italic":0b}],custom_data={TempItem:1b}]
...
item replace block ~ ~ ~ container.25 with anvil[custom_name={"text":"合成する","color":"yellow","italic":false},custom_data={TempItem:1b}]
