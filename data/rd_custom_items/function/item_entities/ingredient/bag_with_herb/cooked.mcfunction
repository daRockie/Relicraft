...
$loot spawn ~ ~ ~ loot {pools:[{rolls:1,entries:[{type:"loot_table","value":"rd_recipe:ingredient/uncraftables/bag_with_smoldering_herbs"}]}],functions:[{function:"set_count",count:$(count)}]}
