function rd_custom_items:talisman/register with entity @s {}
...
#execute if items entity @s armor.head player_head[custom_data~{RD.item:"RD.equipment.villager_artifact"}] run item modify entity @s armor.head rd_custom_items:villager_artifact

advancement revoke @s only rd_custom_items:inventory_check/emerald