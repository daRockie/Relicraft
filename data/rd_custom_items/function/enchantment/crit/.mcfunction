...
execute if data entity @s equipment.mainhand store result score $.crit_level RD.damage_dealt run data get entity @s equipment.mainhand.components."minecraft:enchantments"."rd_custom_items:crit"
execute unless data entity @s equipment.mainhand store result score $.crit_level RD.damage_dealt run data get entity @s SelectedItem.components."minecraft:enchantments"."rd_custom_items:crit"
