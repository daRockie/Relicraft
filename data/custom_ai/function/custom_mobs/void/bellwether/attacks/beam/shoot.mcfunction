...
execute if entity @e[distance=0.01..1,type=!#custom_ai:hostile,type=!#ammos_dont_damage_to,tag=!RD.void_bellwether] run return run function custom_ai:custom_mobs/void/bellwether/attacks/beam/explode with entity @s {}
