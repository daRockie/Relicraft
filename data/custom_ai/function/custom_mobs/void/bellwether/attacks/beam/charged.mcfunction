...
execute anchored eyes facing entity @n[tag=creeper.target] feet positioned ^ ^ ^0.4 rotated as @s positioned ^ ^ ^0.6 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ~ ~ ~ ~ ~
