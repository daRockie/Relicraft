...
execute if predicate rd_custom_ai:percent/20 if predicate custom_items:can_see_sky run return run function rd_asset_mobs:summon/creeper/parachute_creeper
