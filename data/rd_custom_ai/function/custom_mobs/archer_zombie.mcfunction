...
execute if entity @e[tag=zombies.target,distance=0..9] unless block ^ ^ ^1 #rd_custom_ai:no_collision run tag @s add RD.archer_zombie.shooting
...
execute if score @s[predicate=rd_asset_mobs:in_hostile] RD.ai_timer matches 60.. run function rd_custom_ai:movements/archer_zombie/shoot_bow
