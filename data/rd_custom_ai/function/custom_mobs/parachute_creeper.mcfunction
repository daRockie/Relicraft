...
execute unless block ~ ~-0.3 ~ #rd_custom_ai:no_collision run data modify entity @s ignited set value 1b
execute unless block ~ ~-0.3 ~ #rd_custom_ai:no_collision run data modify entity @s NoAI set value 1b
