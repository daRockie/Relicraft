...
execute as @e[type=#minecraft:undead,distance=0.01..16,tag=!RD.zombie_leader.buffed] as @s at @s run function rd_custom_ai:custom_mobs/zombie/leader/accompany_buff
