...
execute if items entity @s armor.head *[item_model="air"] if score @s RD.ai_timer matches 450.. run function rd_custom_ai:custom_mobs/zombie/leader/refill_item
