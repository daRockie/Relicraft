...
execute if entity @s[tag=RD.model.walk] as @n[tag=rd_models.blackstone_golem.root] run function rd_custom_ai:custom_mobs/animated_java/blackstone_golem/anim/walk/walk_stop
