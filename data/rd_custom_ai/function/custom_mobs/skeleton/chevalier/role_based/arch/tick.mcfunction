...
execute if score @s RD.ai_timer matches 120.. anchored eyes facing entity @n[tag=skeleton.target] feet positioned ^ ^ ^-5 run function rd_custom_ai:custom_mobs/skeleton/chevalier/jump_forward
