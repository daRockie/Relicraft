...
execute if score @s[predicate=!rd_asset_mobs:in_hostile] RD.ai_timer_2 matches 60.. run function rd_custom_ai:custom_mobs/void/bellwether/random_warp

execute if block ~ ~ ~ water run function rd_custom_ai:custom_mobs/void/bellwether/damage_water

# execute rotated ~3 ~3 run function rd_custom_ai:custom_mobs/void/bellwether/particle
