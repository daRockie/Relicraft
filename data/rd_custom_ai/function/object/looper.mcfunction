execute if entity @s[type=item_display] run function rd_custom_ai:object/looper_item_display
...
execute if data entity @s equipment.head.components."minecraft:custom_data".data[-1] run function rd_custom_ai:object/looper
