...
execute if score @s RD.ai_timer matches 120.. run function rd_custom_ai:object/flags/zombie_flag/buff
execute if score @s RD.for matches 4.. run function rd_custom_ai:object/flags/zombie_flag/kms
particle ash ~ ~2 ~ 0.5 0.5 0.5 0.05 2

# イタイヨー
execute if entity @s[nbt={HurtTime:9s}] run function rd_custom_ai:object/flags/zombie_flag/hurt
