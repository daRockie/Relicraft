...
execute if score @s RD.ai_timer_2 matches 2 facing entity @n[tag=zombies.target,sort=nearest] eyes anchored eyes run function rd_custom_ai:movements/archer_zombie/summon_arrow with entity @s {}
