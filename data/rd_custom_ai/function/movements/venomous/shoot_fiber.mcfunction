...
execute if score @s RD.ai_timer_2 matches 5 facing entity @e[tag=spider.target,limit=1,sort=nearest] eyes run function rd_custom_ai:movements/venomous/summon_web

execute if score @s RD.temp0 > #_STINGER.SHOOTCAP RD.mobs.temp run function rd_custom_ai:movements/bloodmother/do_spider_jump
