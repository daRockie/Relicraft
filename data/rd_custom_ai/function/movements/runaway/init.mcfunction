...
$summon villager ~ ~ ~ {Health:1024,equipment:{head:{id:"barrier",components:{"custom_data":{"linked":""},item_model:"air",enchantments:{"rd_custom_items:immunity_from_player_attack":1}}}},Tags:["RD.runaway_entity","RD.object"],Silent:1b,active_effects:[{id:"invisibility",duration:999999999,show_particles:false}],attributes:[{id:"knockback_resistance",base:1f},{id:"movement_speed",base:$(speed)f},{id:"max_health",base:1024f},{id:"scale",base:0.94}],Team:"RD.no_friendly_fire"}
